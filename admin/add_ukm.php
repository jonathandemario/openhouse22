...
if($ukm!==0){
    $count = count(query("SELECT * FROM ukm WHERE id = $ukm"));
    if($count>0){
        echo "
        <script>
            alert ('UKM anda sudah terdaftar!!');
...
<body>
    ...
    <div class="container">
        <div class="text-center mb-4">
            <h3>Add new UKM</h3>
            <p class="text-muted">Complete the form below to add a new UKM</p>
        </div>
    </div>
    ...
    <div class="container d-flex justify-content-center">
        <form action="" method="post" enctype = "multipart/form-data" style="width:50vw; min-width 300px;">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="nama" placeholder="UKM ORCHESTRA" required>
            </div>
